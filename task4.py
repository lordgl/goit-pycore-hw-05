...
from task4_helpers import parse_input, display_error_message
from task4_handlers import (
    handle_hello,
    handle_add,
    handle_change,
    handle_phone,
...
COMMAND_HANDLERS = {
    'hello': handle_hello,
    'add': partial(handle_add, contacts_db=CONTACTS_DB),
    'change': partial(handle_change, contacts_db=CONTACTS_DB),
    'phone': partial(handle_phone, contacts_db=CONTACTS_DB),
    'all': partial(handle_all, contacts_db=CONTACTS_DB),
